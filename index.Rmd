...
source("../../phds/helpers.R")

overview <- readRDS("../../phds/overview.rds")

overview_day <- readRDS("../../phds/overview_day.rds")
...
#### How does political microtargeting (PMT) manifest in practice?
...
![](https://pbs.twimg.com/media/GLjdeIOW8AAOR7z?format=jpg&name=medium)
...
2. Sources of Data on Political Microtargeting

  + Collaboration with Who Targets Me
  
  + R package `metatargetr`
  
3. Global Contexts - Study 1

4. Role of Algorithms - Study 2
...
# Slides: favstats.github.io/pollytix_pmt24

.pull-left[

<img src="img/qr-code-fin.png" width = "80%">
...
<img src="https://media.tenor.com/YuaZwKZxXgoAAAAM/write-that-down-taking-notes.gif" width = "80%">
...
![](img/Real Defense.png)

---

class: white

![](img/Real Defense1.png)

---

class: white

![](img/Real Defense2.png)

---

class: white

![](img/Real Defense3.png)

---

class: white

![](img/Real Defense4.png)

---

class: white

![](img/Real Defense5.png)

---

class: white

![](img/Real Defense6.png)
...
+ A form of data-driven campaigning or *DDC* (Dommett et al, 2023)

--

What does more "*susceptible*" mean?

Expectation that it is more *effective* and *efficient*
...
+ Parties and political actors have limited resources

  + need to **optimize**

+ Want go get the most "bang for their buck"

+ PMT allows them to focus on *persuadables* (Hersh, 2015)

+ Don't "waste" money on those less likely to vote (for you)
...
+ may lead to *"political" redlining* (Howard, 2005)

+ fragmentation of the public sphere *(Van der Meer, 2020)*
...
## **Two** Gaps in the PMT Literature
...
+ Browser extensions *(López Ortega, 2022; Silva et al., 2020)*
  ...
  + Who Targets Me, ProPublica, NYU Ad Observer, etc.
...
![](https://favstats.github.io/targex/img/myth.jpg)
]
...
.pull-left[
![](https://scontent-fra3-1.xx.fbcdn.net/v/t39.30808-6/347786240_2021863554822518_1841185963787031595_n.png?_nc_cat=101&ccb=1-7&_nc_sid=6ee11a&_nc_ohc=sAf41Zt0PpMQ7kNvgFSn-AN&_nc_ht=scontent-fra3-1.xx&oh=00_AYBqH7Hjk3XPdQ8n0ViTTirTMbI1Peo3tRDURlY3ucqyzA&oe=669B1033)


]

.pull-right[
![](https://whotargets.me/wp-content/uploads/2023/12/wtm_cartoon-1-1.png)
]
...
<img src="https://exponea.com/wp-content/uploads/2019/11/infographics_03-04.jpg" width="70%">
...
+ Ad Libraries *(e.g. Fowler et al., 2021;  Kruschinski et al., 2022)*
  ...
  + mostly came into effect after Cambridge Analytica Scandal (in 2018)
...
+ **NEW** since August 2023 *only in EU* 
  + age, gender, and location targeting criteria (thank you DSA!)
...
+ 🇪🇺 [2024 European Parliament Elections](https://favstats.github.io/ep2024)
...
**automated systems** decide which individual users get ads from which advertisers
...
-> we consistently find one party that pays less and reaches more people 
...
H2: Party with greatest audience did not reach more or get cheaper prices
...
> So what could influence the prices that political parties pay?
...
+ **Party-Specific Variables**
  ...
  + Specific supporter demographics more active

+ **Market-Context Variables**

  + Total money being spent on target audiences

---

class: white

![](img/Digital Society Conference.png)
...
<center>
<img src="img/spending.jpg" width="80%" height="80%">
</center>
...
<center>
<img src="img/aipmt.png" width="90%" height="90%">
</center>
...
Link to presentation: *favstats.github.io/pollytix_pmt24*
...
<center>
<img src="img/qr-code-fin.png" width="40%">
</center>
...
over_time_gg <- readRDS("../../phds/over_time_gg.rds")
...
```{r}
report_data <- readRDS("../../phds/report_data.rds")
```
...
gender_dat <- readRDS("../../phds/gender.rds") %>% 
  filter(gender != "unknown")

gender_audience <- readRDS("../../phds/audience_joined_gender.rds")
...
.pull-right[
```{r}
age_audience <- readRDS("../../phds/audience_joined_age.rds")
...
.pull-right[
```{r}
region_audience <- readRDS("../../phds/audience_joined_region.rds")
...
+ Interviews *(e.g. Kefford et al. 2023; Dommett et al. 2024)*
...
![](https://pbs.twimg.com/media/F3kdUt-XAAAR_l7?format=jpg&name=small)
